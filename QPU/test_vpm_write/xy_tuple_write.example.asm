...
#
# Note: The vertical setup for vpm write, but horizontal for
# the vdw write. The horizontal write allows us to get an
# offset after each value, but not each block (16 values)
#
# Note: Placing the y values right of the x values in the
#       VPM probably leads to a single dma write command?! 
#############################################################
...
#############################################################
## Geometry of VPM pushing (xxxx=word):
#   (0)  (5)         (F)   
#  0 0000 ****     ****
#(0) 1111 **** ... ****
#  2 2222 ****     ****
